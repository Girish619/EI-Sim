...
String actualfontWeight= WebUI.getCSSValue(mail_Xpath, 'font-weight')
String expectedWeight='700'
CustomKeywords.'customKeywords.Validations.validateText'(actualfontWeight, expectedWeight)
