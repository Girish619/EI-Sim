...
String actualColor= WebUI.getCSSValue(mail_Xpath, 'color')
String expectedColor='rgba(71, 76, 76, 1)'
CustomKeywords.'customKeywords.Validations.validateText'(actualColor, expectedColor)
