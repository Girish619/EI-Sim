...
//---validating New response in mails
	...
	if (conversation_ID.contains('call')) {
		...
		WebUI.callTestCase(findTestCase('Validate_CallConversations'), [('i'):i], FailureHandling.STOP_ON_FAILURE)
	}
}
